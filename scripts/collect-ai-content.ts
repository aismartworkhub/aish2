...
const DEFAULT_BOARD_CONFIGS: BoardCollectionConfig[] = [
  ...
  { boardKey: "community-notice", label: "AI 뉴스", enabled: true, maxItems: 2, minQualityScore: 7, sources: ["hackernews", "devto", "reddit", "xcom"], requireReview: false },
  { boardKey: "community-free", label: "AI 커뮤니티 글", enabled: true, maxItems: 3, minQualityScore: 7, sources: ["hackernews", "devto", "reddit", "xcom"], requireReview: false },
];
