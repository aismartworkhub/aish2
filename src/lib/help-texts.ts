...
export const HELP_TEXTS: Record<string, string> = {
  ...
  // ── 관리자: 교육 운영 ──
  "admin.programs": "교육 프로그램은 Runmoa(aish.runmoa.com)에서 등록·수정합니다. 이 화면에서는 홈·교육과정 카드의 노출 순서, 숨김, 그리고 표시 내용(제목·설명·대표이미지·유형·가격)을 이 사이트에 맞게 덮어쓸 수 있습니다. 프로그램을 클릭하거나 연필 아이콘을 눌러 편집 후 저장하면 홈·교육과정에 반영됩니다(수강신청 상세 페이지는 Runmoa 원본이 유지됩니다).",
