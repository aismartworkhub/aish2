    ...
    <>
      ...
      <section className="flex flex-col md:flex-row min-h-[550px]">
        ...
        <div className="flex-1 bg-white p-12 md:p-16 flex flex-col justify-center">
          ...
          <Link
            href="/workathon"
            className="mt-8 inline-flex items-center gap-2 text-brand-blue font-semibold text-sm hover:text-brand-blue transition-colors"
          >
            워크톤 자세히 보기
            <ArrowRight size={16} />
          </Link>
      ...
      <section className="py-24 md:py-28 bg-brand-gray">
        <div className="container-custom">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link
              href="/programs"
              className="hidden md:inline-flex items-center gap-1 text-sm text-gray-500 hover:text-brand-blue transition-colors font-medium"
            >
              전체 보기
              ...
              ? runmoaPrograms.slice(0, 8).map((c) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="text-sm font-bold text-gray-900 group-hover:text-brand-blue transition-colors line-clamp-1">
                        {c.title}
                      </h3>
                      <p className="mt-1.5">
          ...
          <div className="text-center mt-10 md:hidden">
            <Link
              href="/programs"
              className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-brand-blue transition-colors font-medium"
            >
              전체 보기
              <ChevronRight size={16} />
            </Link>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {reviews.map((review, index) => (
              <div
                key={index}
                ref={addRevealRef}
                className="bg-white rounded-sm p-6 border border-brand-border hover:shadow-md transition-shadow"
              >
