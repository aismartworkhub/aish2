  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">긴급등록 (Firestore 직접 관리)</h1>
          <p className="text-gray-500 mt-1">Firestore에 직접 프로그램을 등록·수정합니다. 일반 등록은 프로그램 관리 메뉴를 이용하세요.</p>
        </div>
        <button
