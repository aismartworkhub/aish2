...
type Program = (typeof DEMO_PROGRAMS)[number];
...
export default function AdminProgramsPage() {
 ...
 const handleSave = () => {
   const instructorsArray = formData.instructors
     .split(",")
     .map((s) => s.trim())
     .filter(Boolean);
             ...
             {filteredPrograms.map((program) => (
               ...
               >
                 ...
                 <td className="px-4 py-4">
                   ...
                   {program.cohort && (
                     <div className="text-xs text-gray-400 mt-0.5">{program.cohort}</div>
                   )}
                 </td>
                 <td className="px-4 py-4">
           ...
           <div className="px-6 py-5 space-y-4">
             ...
             <div>
               ...
               <input
                 ...
                 onChange={(e) => updateField("instructors", e.target.value)}
                 className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20"
